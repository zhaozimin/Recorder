...
# -*- coding: utf-8 -*-
"""
[INPUT]: 依赖 AppKit(PyObjC) 的 NSTextView/NSScrollView/NSApp 等；依赖 ui_common 的 KeyWindow(补回 Cmd+C/V/X/A/Z)/BtnTarget/make_rich_label
...
"""
from AppKit import (
    NSTextView, NSScrollView, NSButton, NSApp, NSFont,
...
from ui_common import (
    BtnTarget, KeyWindow, make_rich_label, title_font, body_font,
...
class ReplaceWindow:
    def __init__(self, initial_text: str):
        ...
        tv.setAllowsUndo_(True)            # 配合 Cmd+Z/Cmd+Shift+Z 撤销/重做
