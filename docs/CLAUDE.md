...
## 成员清单
- `logo.png`: README hero logo。3D 写实深色 squircle 应用图标(麦克风+无限符号+绛红线，源自 `packaging/macos/VoiceLog_iconmaster.png`，1024x1024，自带深色背景，亮/暗主题皆稳)。README 顶部以 `<img width="160">` 居中引用。换图只需覆盖此文件，无需动 README。
